...
class ConsensusController extends Controller
{
    ...
    public function show(DecisionIssue $issue)
    {
        ...
        return Inertia::render('Cds/Consensus/Show', [
            'issue' => $issue,
    ...
    {
        return Inertia::render('Cds/Consensus/Create', [
            'issue' => $issue,
    ...
    public function store(DecisionIssue $issue, Request $request)
    {
        ...
        return redirect()->route('cds.consensus.show', ['issue' => $issue, 'consensus' => $consensus])
