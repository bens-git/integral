...
class IssueController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Csd/Issues/Index', [
            'issues' => $issues,
    ...
    public function show(DecisionIssue $issue)
    {
        ...
        return Inertia::render('Csd/Issues/Show', [
            'issue' => $issue,
        ]);
    }
    ...
    {
        return Inertia::render('Csd/Issues/Create', [
            'proposal' => $proposal,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('csd.issues.show', $issue)
