...
class ProposalController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('Csd/Proposals/Index', [
            'proposals' => $proposals,
    ...
    {
        return Inertia::render('Csd/Proposals/Create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('csd.proposals.show', $proposal)
    ...
    public function show(Proposal $proposal)
    {
        ...
        return Inertia::render('Csd/Proposals/Show', [
            'proposal' => $proposal,
        ]);
    }
    ...
    {
        return Inertia::render('Csd/Proposals/Edit', [
            'proposal' => $proposal,
            'categories' => ['policy', 'resource', 'design', 'coordination', 'review'],
            'priorities' => ['low', 'normal', 'high', 'urgent'],
            'scopes' => ['local', 'regional', 'bioregional', 'global'],
