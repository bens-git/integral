...
const stats = [
    { name: 'Active Proposals', value: 12, href: '/csd/proposals?status=active', color: 'bg-blue-500' },
    { name: 'Issues in Deliberation', value: 5, href: '/csd/issues?status=deliberation', color: 'bg-green-500' },
    { name: 'Consensus Reached', value: 8, href: '/csd/issues?status=decided', color: 'bg-purple-500' },
    { name: 'Pending Decisions', value: 3, href: '/csd/decisions', color: 'bg-orange-500' },
];
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <Link :href="route('csd.issues.index')"
                                class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                View Issues
                            </Link>
                            <Link :href="route('csd.decisions.index')"
                                class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Decision Ledger
                            </Link>
                        </div>
