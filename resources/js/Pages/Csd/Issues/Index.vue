...
function filterByStatus(status) {
    router.get(route('csd.issues.index'), { status }, { preserveState: true });
}

function filterByType(type) {
    router.get(route('csd.issues.index'), { decision_type: type }, { preserveState: true });
}
</script>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <div class="flex items-center gap-3 mb-2">
                                            <Link :href="route('csd.issues.show', issue.id)"
