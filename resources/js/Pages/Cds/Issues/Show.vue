...
function updateStatus() {
    statusForm.post(route('cds.issues.update-status', props.issue.id));
}
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <Link v-if="issue.status === 'draft' || issue.status === 'framing'"
                                    :href="route('cds.issues.frame', issue.id)"
                                ...
                                <Link v-if="issue.status === 'framing'"
                                    :href="route('cds.issues.start-deliberation', issue.id)"
                                    class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">
                                    Start Deliberation
                                </Link>
                                <Link v-if="issue.status === 'deliberation'"
                                    :href="route('cds.consensus.create', { issue: issue.id })"
                    ...
                    <div class="p-6">
                        ...
                        <div v-if="activeTab === 'deliberation'" class="space-y-4">
                            <div class="flex justify-between items-center">
                                ...
                                <Link :href="route('cds.deliberation.store', { issue: issue.id })"
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <div class="flex items-center gap-2 mb-1">
                                                ...
                                                <Link :href="route('cds.deliberation.show', thread.id)"
